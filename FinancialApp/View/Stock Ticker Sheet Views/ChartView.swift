...
struct ChartView<ChartViewModelObservable>: View where ChartViewModelObservable: ChartViewModelProtocol {
    let data: ChartViewData
    @ObservedObject var viewModel: ChartViewModelObservable
...
struct ChartView_Previews: PreviewProvider {
    ...
    static func chartViewModel(range: ChartRange, stub: ChartData) -> ChartViewModel {
        ...
        let chartVM = ChartViewModel(ticker: .stub, dataService: mockStocksAPI)
...
struct ChartContainerView_Previews: View {
    ...
    var body: some View {
        VStack {
            Text(title)
                .padding(.bottom)
            if let chartViewData = viewModel.selectedChart {
